  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const achievements: HubAchievement[] = [
        { code: "first_quiz",      label: "First quiz",       earned: completedYou >= 1,                              points: 25,  tier: "bronze" },
        { code: "5_day_streak",    label: "5-day streak",     earned: true,                                           points: 50,  tier: "bronze" },
        { code: "module_1",        label: "Module 1",         earned: completedYou >= 3,                              points: 75,  tier: "silver" },
        { code: "peer_mentor",     label: "Peer mentor",      earned: true,                                           points: 75,  tier: "silver" },
        { code: "first_reflection",label: "First reflection", earned: true,                                           points: 25,  tier: "bronze" },
        { code: "module_2",        label: "Module 2",         earned: completedYou >= 6,                              points: 100, tier: "silver" },
        { code: "mock_ace",        label: "Mock ace",         earned: false,                                          points: 100, tier: "silver" },
        { code: "30_day_streak",   label: "30-day streak",    earned: false,                                          points: 125, tier: "silver" },
        { code: "module_3",        label: "Module 3",         earned: false,                                          points: 150, tier: "silver" },
        { code: "top_10",          label: "Top 10",           earned: yourRank <= 10 && yourRank > 0 && totalLearners >= 10, points: 150, tier: "gold" },
        { code: "cohort_lead_nom", label: "Cohort lead",      earned: false,                                          points: 175, tier: "gold" },
        { code: "module_4",        label: "Module 4",         earned: false,                                          points: 200, tier: "gold" },
        { code: "cisi_l4",         label: "CISI L4",          earned: false,                                          points: 200, tier: "gold" },
        { code: "fca_notified",    label: "FCA notified",     earned: false,                                          points: 250, tier: "gold" },
        { code: "programme_grad",  label: "Graduate",         earned: false,                                          points: 300, tier: "gold" },
        { code: "client_handover", label: "Handover",         earned: false,                                          points: 200, tier: "gold" },
      ];
