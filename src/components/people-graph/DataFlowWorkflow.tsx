...
const consumerNodes: ConsumerNode[] = [
  ...
  { id: "learnpath", label: "Embark AI", icon: <BookOpen className="h-5 w-5" />, color: "from-teal-500/20 to-teal-600/10 border-teal-500/30", signals: ["Module recommendations", "Assessment calibration", "Content sequencing"] },
