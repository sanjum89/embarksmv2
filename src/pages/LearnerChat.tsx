                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-2.5">
                        ...
                        <div className="min-w-0">
                          <div className="text-xs font-semibold text-foreground leading-tight">Resume onboarding</div>
                          <div className="text-[11px] text-muted-foreground mt-0.5 leading-snug">Pick up the next Embark AI chapter.</div>
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-2">
                        <div className="rounded-lg bg-muted/40 px-2 py-2">
                          <div className="flex items-center gap-1 text-[10px] text-muted-foreground"><CheckCircle2 className="h-3 w-3 text-primary" /> This week</div>
                          <div className="text-sm font-semibold text-foreground mt-0.5">3 chapters</div>
                        </div>
                        <div className="rounded-lg bg-muted/40 px-2 py-2">
                          <div className="flex items-center gap-1 text-[10px] text-muted-foreground"><Users className="h-3 w-3 text-primary" /> Cohort</div>
                          <div className="text-sm font-semibold text-foreground mt-0.5">5 active</div>
                        </div>
                      </div>
                      <button
                        onClick={() => navigate("/")}
                        className="w-full rounded-lg bg-primary/10 px-2.5 py-2 text-left text-xs font-semibold text-primary hover:bg-primary/15 transition-colors"
                      >
                        Open Embark AI
                      </button>
                    </div>
