...
const consumerNodes: ConsumerNode[] = [
  ...
  { id: "learnpath", label: "LearnPath", icon: <BookOpen className="h-4 w-4" />, color: "text-teal-400", bgColor: "bg-teal-500/15 border-teal-500/30", signals: ["Module recommendations", "Assessment calibration", "Content sequencing"] },
