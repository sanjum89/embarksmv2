...
export const mockLearningModules: LearningModule[] = [
  ...
  ...expandedModules,
  // Rathbones modules — rich transcripts from rathbonesTranscripts
  { id: "m-rb1", title: "Rathbones Investment Manager Role and Good Client Outcomes", contentType: "document", contentUrl: "https://example.com/rathbones-im-role.pdf", duration: "20 min", transcript: rathbonesTranscripts["m-rb1"] },
  { id: "m-rb2", title: "Leading Client Relationships with Confidence", contentType: "video", contentUrl: "https://example.com/rathbones-client-relationships", duration: "25 min", transcript: rathbonesTranscripts["m-rb2"] },
  { id: "m-rb3", title: "Suitability, Documentation, and Client Fairness", contentType: "document", contentUrl: "https://example.com/rathbones-suitability.pdf", duration: "20 min", transcript: rathbonesTranscripts["m-rb3"] },
  { id: "m-rb4", title: "Working with Financial Planning, Portfolio Management, and Client Support", contentType: "video", contentUrl: "https://example.com/rathbones-internal-collab", duration: "25 min", transcript: rathbonesTranscripts["m-rb4"] },
  { id: "m-rb5", title: "Investment Process and Portfolio Alignment Basics", contentType: "document", contentUrl: "https://example.com/rathbones-investment-process.pdf", duration: "20 min", transcript: rathbonesTranscripts["m-rb5"] },
  { id: "m-rb6", title: "Communicating Clearly with Clients and Internal Partners", contentType: "video", contentUrl: "https://example.com/rathbones-communication", duration: "25 min", transcript: rathbonesTranscripts["m-rb6"] },
  { id: "m-rb7", title: "Professional Integrity, Attention to Detail, and Ownership", contentType: "document", contentUrl: "https://example.com/rathbones-integrity.pdf", duration: "15 min", transcript: rathbonesTranscripts["m-rb7"] },
  // Rathbones Introduction modules — dedicated content for the Intro to Rathbones skill target
...
export const mockSkillTargets: SkillTarget[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s16", type: "module", title: "Apple Product Ecosystem Overview", description: "Overview of the Apple hardware and software ecosystem.", order: 2, skippable: true, skipCondition: "Pre-assessment score > 80%", status: "locked", duration: "25 min", referenceId: "m6", learningFormat: "auto_skip" as const },
      { id: "s17", type: "module", title: "Apple ID and iCloud Fundamentals", description: "Deep dive into Apple ID management and iCloud services.", order: 3, skippable: true, skipCondition: "Pre-assessment score ≥ 90%", status: "locked", duration: "30 min", referenceId: "m7", learningFormat: "auto_skip" as const },
      { id: "s18", type: "module", title: "iPhone and iPad Basics", description: "Core knowledge for supporting iPhone and iPad users.", order: 4, skippable: false, status: "locked", duration: "25 min", referenceId: "m8", learningFormat: "micro" as const },
      { id: "s19", type: "module", title: "Mac Basics for Support", description: "Essential Mac knowledge for L1 support agents.", order: 5, skippable: false, status: "locked", duration: "20 min", referenceId: "m9", learningFormat: "micro" as const },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s33", type: "module", title: "iPhone and iPad Basics", description: "Core knowledge for supporting iPhone and iPad users.", order: 3, skippable: false, status: "available", duration: "25 min", referenceId: "m8", learningFormat: "micro" as const },
      { id: "s34", type: "module", title: "Mac Basics for Support", description: "Essential Mac knowledge for L1 support agents.", order: 4, skippable: false, status: "locked", duration: "20 min", referenceId: "m9", learningFormat: "micro" as const },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s59b", type: "assessment", title: "Final Knowledge Check", description: "Comprehensive assessment covering all Apple L1 support topics before the live simulation.", order: 15, skippable: false, status: "locked", duration: "20 min", referenceId: "a8" },
  ...
  {
    id: "st-rb-clara",
    title: "Rathbones Investment Manager Foundations",
    description: "Build the common foundation for the Investment Manager role — client relationships, suitability and documentation, client outcomes, investment process basics, and communication standards.",
    category: "Rathbones Wealth Management",
    assignedTo: ["u12"],
    progress: 22,
    dueDate: "2026-05-30",
    skills: [
      { name: "Client Relationship Management", current: "Beginner", target: "Intermediate" },
      { name: "Suitability and Documentation", current: "Beginner", target: "Intermediate" },
      { name: "Investment Communication", current: "Beginner", target: "Intermediate" },
      { name: "Active Listening", current: "Intermediate", target: "Advanced" },
    ],
    steps: [
      { id: "s-rb-c1", type: "module", title: "Rathbones Investment Manager Role and Good Client Outcomes", description: "Core responsibilities, fiduciary duty, and what constitutes good client outcomes.", order: 1, skippable: true, status: "completed", duration: "20 min", referenceId: "m-rb1", learningFormat: "micro" as const },
      { id: "s-rb-c2", type: "module", title: "Leading Client Relationships with Confidence", description: "Building and maintaining strong client relationships at Rathbones.", order: 2, skippable: true, status: "completed", duration: "25 min", referenceId: "m-rb2", learningFormat: "micro" as const },
      { id: "s-rb-c3", type: "module", title: "Suitability, Documentation, and Client Fairness", description: "Suitability assessment, documentation standards, and fair treatment.", order: 3, skippable: false, status: "available", duration: "20 min", referenceId: "m-rb3" },
      { id: "s-rb-c4", type: "module", title: "Working with Financial Planning, Portfolio Management, and Client Support", description: "Internal collaboration across Financial Planning, Portfolio Management, and Client Support.", order: 4, skippable: false, status: "locked", duration: "25 min", referenceId: "m-rb4", learningFormat: "micro" as const },
      { id: "s-rb-c5", type: "assessment", title: "Client Outcomes and Suitability Checkpoint", description: "Checkpoint covering client outcomes, suitability, and relationship handling.", order: 5, skippable: false, status: "locked", duration: "15 min", referenceId: "a-rb1" },
      { id: "s-rb-c6", type: "module", title: "Investment Process and Portfolio Alignment Basics", description: "Rathbones' investment process, asset allocation, and portfolio alignment.", order: 6, skippable: false, status: "locked", duration: "20 min", referenceId: "m-rb5" },
      { id: "s-rb-c7", type: "module", title: "Communicating Clearly with Clients and Internal Partners", description: "Plain-language communication, professional correspondence, and internal collaboration.", order: 7, skippable: false, status: "locked", duration: "25 min", referenceId: "m-rb6" },
      { id: "s-rb-c8", type: "module", title: "Professional Integrity, Attention to Detail, and Ownership", description: "Professional standards, ethical conduct, and personal ownership of client outcomes.", order: 8, skippable: false, status: "locked", duration: "15 min", referenceId: "m-rb7" },
      { id: "s-rb-c9", type: "role_play", title: "First Client Intro and Risk Appetite Conversation", description: "Role play combining first client introduction, risk appetite assessment, and relationship building.", order: 9, skippable: false, status: "locked", duration: "20 min", referenceId: "rp-rb1" },
    ],
  },
  {
    id: "st-rb-elliot",
    ...
    steps: [
      { id: "s-rb-e1", type: "module", title: "Rathbones Investment Manager Role and Good Client Outcomes", description: "Core responsibilities, fiduciary duty, and what constitutes good client outcomes.", order: 1, skippable: true, status: "completed", duration: "20 min", referenceId: "m-rb1" },
      { id: "s-rb-e2", type: "module", title: "Leading Client Relationships with Confidence", description: "Building and maintaining strong client relationships at Rathbones.", order: 2, skippable: true, status: "completed", duration: "25 min", referenceId: "m-rb2" },
      { id: "s-rb-e3", type: "module", title: "Suitability, Documentation, and Client Fairness", description: "Suitability assessment, documentation standards, and fair treatment.", order: 3, skippable: false, status: "available", duration: "20 min", referenceId: "m-rb3" },
      { id: "s-rb-e4", type: "module", title: "Working with Financial Planning, Portfolio Management, and Client Support", description: "Internal collaboration across Financial Planning, Portfolio Management, and Client Support.", order: 4, skippable: false, status: "locked", duration: "25 min", referenceId: "m-rb4" },
      { id: "s-rb-e5", type: "assessment", title: "Client Outcomes and Suitability Checkpoint", description: "Checkpoint covering client outcomes, suitability, and relationship handling.", order: 5, skippable: false, status: "locked", duration: "15 min", referenceId: "a-rb1" },
      { id: "s-rb-e6", type: "module", title: "Investment Process and Portfolio Alignment Basics", description: "Rathbones' investment process, asset allocation, and portfolio alignment.", order: 6, skippable: false, status: "locked", duration: "20 min", referenceId: "m-rb5" },
      { id: "s-rb-e7", type: "module", title: "Communicating Clearly with Clients and Internal Partners", description: "Plain-language communication, professional correspondence, and internal collaboration.", order: 7, skippable: false, status: "locked", duration: "25 min", referenceId: "m-rb6" },
      { id: "s-rb-e8", type: "module", title: "Professional Integrity, Attention to Detail, and Ownership", description: "Professional standards, ethical conduct, and personal ownership of client outcomes.", order: 8, skippable: false, status: "locked", duration: "15 min", referenceId: "m-rb7" },
      { id: "s-rb-e9", type: "role_play", title: "First Client Intro and Risk Appetite Conversation", description: "Role play combining first client introduction, risk appetite assessment, and relationship building.", order: 9, skippable: false, status: "locked", duration: "20 min", referenceId: "rp-rb1" },
    ],
  },
  {
    id: "st-rb-sophie",
    ...
    steps: [
      { id: "s-rb-s1", type: "module", title: "Rathbones Investment Manager Role and Good Client Outcomes", description: "Core responsibilities, fiduciary duty, and what constitutes good client outcomes.", order: 1, skippable: false, status: "available", duration: "20 min", referenceId: "m-rb1" },
      { id: "s-rb-s2", type: "module", title: "Leading Client Relationships with Confidence", description: "Building and maintaining strong client relationships at Rathbones.", order: 2, skippable: false, status: "locked", duration: "25 min", referenceId: "m-rb2" },
      { id: "s-rb-s3", type: "module", title: "Suitability, Documentation, and Client Fairness", description: "Suitability assessment, documentation standards, and fair treatment.", order: 3, skippable: false, status: "locked", duration: "20 min", referenceId: "m-rb3" },
      { id: "s-rb-s4", type: "module", title: "Working with Financial Planning, Portfolio Management, and Client Support", description: "Internal collaboration across Financial Planning, Portfolio Management, and Client Support.", order: 4, skippable: false, status: "locked", duration: "25 min", referenceId: "m-rb4" },
      { id: "s-rb-s5", type: "assessment", title: "Client Outcomes and Suitability Checkpoint", description: "Checkpoint covering client outcomes, suitability, and relationship handling.", order: 5, skippable: false, status: "locked", duration: "15 min", referenceId: "a-rb1" },
      { id: "s-rb-s6", type: "module", title: "Investment Process and Portfolio Alignment Basics", description: "Rathbones' investment process, asset allocation, and portfolio alignment.", order: 6, skippable: false, status: "locked", duration: "20 min", referenceId: "m-rb5" },
      { id: "s-rb-s7", type: "module", title: "Communicating Clearly with Clients and Internal Partners", description: "Plain-language communication, professional correspondence, and internal collaboration.", order: 7, skippable: false, status: "locked", duration: "25 min", referenceId: "m-rb6" },
      { id: "s-rb-s8", type: "module", title: "Professional Integrity, Attention to Detail, and Ownership", description: "Professional standards, ethical conduct, and personal ownership of client outcomes.", order: 8, skippable: false, status: "locked", duration: "15 min", referenceId: "m-rb7" },
      { id: "s-rb-s9", type: "role_play", title: "First Client Intro and Risk Appetite Conversation", description: "Role play combining first client introduction, risk appetite assessment, and relationship building.", order: 9, skippable: false, status: "locked", duration: "20 min", referenceId: "rp-rb1" },
    ],
  },
];

// Add Rathbones onboarding targets (Intro, Bridge, ST2)
// NOTE: introToRathbones (generic) is kept for backwards compat; per-persona intros are resolved at runtime in SkillTargetsContext
import { introToRathbones, elliotDomainBridge, claraSkillTarget2, elliotSkillTarget2, sophieSkillTarget2, buildIntroToRathbones } from "@/data/rathbonesOnboarding";
mockSkillTargets.push(introToRathbones, elliotDomainBridge, claraSkillTarget2, elliotSkillTarget2, sophieSkillTarget2);

/** Build persona-aware Rathbones targets for a specific user */
export function getPersonaSkillTargets(userId: string, baseTargets: SkillTarget[]): SkillTarget[] {
...
export const mockRolePlayBank: RolePlay[] = [
  ...
  // ── Module-specific role plays for Embark AI hands-on mode ──
  ...
  // ── Dedicated role plays per module ──
  { id: "rp-rb-value-articulation", title: "Prospect Challenges Your Fee Justification", scenario: "A cost-conscious prospect is comparing Rathbones to a passive Vanguard fund. Articulate the full value proposition — bespoke construction, tax efficiency, holistic planning, and ongoing proactive advice.", difficulty: "intermediate", isPrivate: false, tags: ["wealth-management", "fees", "value-proposition", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Simon Archer, 49, serial entrepreneur, £3M liquid assets, currently self-directed", context: "Simon is highly numerate and runs his own spreadsheets. He has calculated that passive index funds would save him £25k/year in fees. He is open to being convinced but needs specific, quantifiable value — not vague promises. He will press on alpha generation, tax alpha, and whether discretionary management genuinely adds value after costs. He responds well to data and real examples, poorly to generalities." } },
  { id: "rp-rb-risk-profiling", title: "Client Risk Profile Reassessment After Life Change", scenario: "A client's risk tolerance appears to have shifted after a major life event. Conduct a sensitive reassessment of their risk profile and adjust the mandate if appropriate.", difficulty: "intermediate", isPrivate: false, tags: ["wealth-management", "risk-profiling", "suitability", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Helen Dawson, 56, recently diagnosed with a chronic illness, £1.1M portfolio", context: "Helen was previously a confident investor comfortable with a growth-oriented portfolio. Since her diagnosis, she is anxious about capital preservation and wants to ensure her family is financially secure if her health deteriorates. She may become emotional. She needs empathy and a structured reassessment, not assumptions about what she wants. She will test whether you truly listen or just follow a script." } },
  { id: "rp-rb-portfolio-construction", title: "Discussing a Concentrated Position with an Emotional Client", scenario: "A client holds 40% of their portfolio in a single stock they inherited. Help them understand concentration risk while respecting their emotional attachment to the holding.", difficulty: "intermediate", isPrivate: false, tags: ["wealth-management", "portfolio-construction", "diversification", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Jonathan Whitfield, 62, retired headteacher, inherited £450k in BP shares from his late father", context: "Jonathan's father worked at BP for 35 years and the shares represent a deep emotional connection. He intellectually understands diversification but emotionally resists selling. He will become defensive if you push too hard. A phased approach with clear reasoning works best. He will ask about CGT implications and wants to understand the timeline." } },
  { id: "rp-rb-internal-collab", title: "Multi-Team Coordination on a Divorce Case", scenario: "A client couple is divorcing and both wish to remain clients. Coordinate with Financial Planning, Compliance, and Portfolio Management to handle the situation professionally.", difficulty: "advanced", isPrivate: false, tags: ["wealth-management", "collaboration", "divorce", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Sarah Chen, Head of Financial Planning — initially sceptical of your preparation", context: "Sarah is experienced and expects a clear, structured brief when you engage her team. She will test your understanding of the tax implications of asset division, pension sharing orders, and CGT on portfolio restructuring. If your brief is vague, she will push back firmly. She values conciseness, accuracy, and evidence that you've thought through the client's full financial picture before engaging her team." } },
  { id: "rp-rb-clear-communication", title: "Explaining Alternative Investments to a Non-Financial Client", scenario: "Explain a 15% allocation to infrastructure funds and absolute return strategies to a client with no financial background. Use analogies and plain language.", difficulty: "beginner", isPrivate: false, tags: ["wealth-management", "communication", "client-education", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Barbara Mitchell, 70, retired teacher, £500k portfolio, no financial background", context: "Barbara trusts her IM but wants to understand what she's invested in. She will ask questions like 'But what actually IS an infrastructure fund?' and 'Could I lose all my money in this?' She needs patient, jargon-free explanations with relatable analogies. She will become confused and slightly anxious if you use technical language. She appreciates honesty about risks." } },
  { id: "rp-rb-documentation", title: "Documenting Investment Decisions Under Time Pressure", scenario: "You've made three tactical trades this morning and haven't documented any of them. Practice articulating clear, contemporaneous rationale for each decision.", difficulty: "intermediate", isPrivate: false, tags: ["wealth-management", "documentation", "compliance", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Claire Ramsay, Compliance Officer conducting a spot-check of your trade documentation", context: "Claire has noticed a pattern of delayed documentation in your recent trades. She is professional but firm. She will ask you to walk through the rationale for each of your three trades this morning, why you chose those specific timings, and what documentation you've completed. She will probe for gaps and test whether your verbal rationale matches what should be written down. She expects specificity, not generalities." } },
  { id: "rp-rb-fee-discussion", title: "Annual Review Fee Challenge from a Long-Standing Client", scenario: "At an annual review, a loyal client of 8 years questions whether your fees are justified compared to robo-advisers charging 0.25%. Defend the value without being defensive.", difficulty: "intermediate", isPrivate: false, tags: ["wealth-management", "fees", "annual-review", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Andrew Pemberton, 65, retired surgeon, £1.8M portfolio, client for 8 years", context: "Andrew has been a loyal, low-maintenance client but his nephew — a fintech analyst — has been telling him about robo-advisers. Andrew isn't threatening to leave; he's genuinely curious whether the fee differential is justified. He will cite specific numbers his nephew quoted. He wants a thoughtful, honest answer — not a sales pitch. He will respect transparency, even if the answer includes acknowledging where robo-advisers have some advantages." } },
  { id: "rp-rb-domain-vocab", title: "Bridging Banking Terminology in a Wealth Management Setting", scenario: "In your first client-facing week after joining from banking, translate your financial services knowledge into wealth management language during a team meeting.", difficulty: "beginner", isPrivate: false, tags: ["wealth-management", "domain-bridge", "terminology", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Marcus Wright, Senior IM and your assigned buddy for the domain-bridge programme", context: "Marcus is supportive but direct. He uses wealth management terminology naturally and wants to help you build fluency. He will use terms like 'mandate', 'capacity for loss', 'risk tolerance vs risk capacity', 'suitability', and 'discretionary management'. He will gently correct banking equivalents and explain the regulatory significance of each term. He expects you to actively engage, ask questions, and show you're building a glossary." } },
  { id: "rp-rb-bespoke-vs-product", title: "Explaining Bespoke vs Product Distribution to a Former Colleague", scenario: "A former IFA colleague challenges you: 'Isn't wealth management just selling the same funds through a more expensive wrapper?' Articulate the genuine difference.", difficulty: "beginner", isPrivate: false, tags: ["wealth-management", "domain-bridge", "bespoke", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Tom Gallagher, 38, your former colleague from retail banking, now an IFA", context: "Tom is genuinely curious but also slightly envious of your move to wealth management. He will challenge you with questions about whether bespoke portfolios really outperform model portfolios, what individual security selection achieves that fund selection doesn't, and whether the higher fees are justified for the client. He's knowledgeable about funds and platforms, so generic answers won't work — you need to show you understand the structural difference." } },
  { id: "rp-rb-rate-impact", title: "Explaining Interest Rate Impact on Bond Holdings to a Client", scenario: "A client with banking background asks about rising interest rates and their bond holdings. Leverage your shared vocabulary while translating to portfolio-specific implications.", difficulty: "intermediate", isPrivate: false, tags: ["wealth-management", "domain-bridge", "fixed-income", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Dr. Priya Sharma, 52, former bank treasurer, now running a family office with £4M portfolio", context: "Priya has deep technical knowledge of interest rates from her banking career. She will use precise terminology (duration, convexity, yield curve positioning) and expects you to engage at that level. However, she wants to understand how Rathbones specifically manages duration risk in her portfolio and what the IC's current positioning is on rates. She will probe whether you understand the difference between managing a bank's balance sheet and managing a private client's bond allocation." } },
  { id: "rp-rb-gap-recognition", title: "Recognising and Addressing Knowledge Gaps as a New Joiner", scenario: "A client asks about the IC's latest positioning change and its impact on their portfolio. You understand the note but aren't sure how to apply it to this specific mandate.", difficulty: "beginner", isPrivate: false, tags: ["wealth-management", "domain-bridge", "self-awareness", "rathbones"], assignedTo: ["u12", "u13", "u14"], aiCloneConfig: { persona: "Elizabeth Thornton, 72, established client with a cautious mandate and £900k portfolio", context: "Elizabeth is patient and understanding but expects competence. She has been a Rathbones client for 12 years and knew your predecessor well. She will ask specific questions about how the IC's latest underweight in UK equities affects her particular portfolio mix. If you try to bluff, she will notice inconsistencies. She responds well to honesty and a promise to follow up with a thorough answer. She will lose trust quickly if she senses overconfidence without substance." } },
];
...
export const moduleRolePlayMap: Record<string, string[]> = {
  ...
  "RAT-LM-001": ["rp-rb-value-articulation"],
  "RAT-LM-002": ["rp-rb-risk-profiling"],
  "RAT-LM-003": ["rp-rb-portfolio-construction"],
  "RAT-LM-004": ["rp-rb-volatility"],
  "RAT-LM-005": ["rp-rb-internal-collab"],
  "RAT-LM-006": ["rp-rb-integrity"],
  "RAT-LM-007": ["rp-rb-clear-communication"],
  "RAT-LM-008": ["rp-rb-documentation"],
  "RAT-LM-009": ["rp-rb-fee-discussion"],
  "RAT-LM-010": ["rp-rb-volatility"],
  "RAT-BR-001": ["rp-rb-domain-vocab"],
  "RAT-BR-LM-001": ["rp-rb-domain-vocab"],
  "RAT-BR-002": ["rp-rb-bespoke-vs-product"],
  "RAT-BR-LM-002": ["rp-rb-bespoke-vs-product"],
  "RAT-BR-003": ["rp-rb-rate-impact"],
  "RAT-BR-LM-003": ["rp-rb-rate-impact"],
  "RAT-BR-LM-004": ["rp-rb-gap-recognition"],
};
...
export const profileDataByUser: Record<string, ProfileData> = {
  ...
  u10: {
    ...
    team: "Apple L1 Customer Care",
    summary:
      "Recent graduate with a degree in Communications. No prior customer support experience but demonstrates strong interpersonal skills developed through university projects and a summer internship in retail. Joined the Apple L1 Customer Support Program as a fresher and is starting her training from scratch.",
    roleSnapshotText: "As a Customer Support Executive L1, you handle first-line customer queries across account access, product or service basics, troubleshooting, billing questions, and guided support.",
    projectSnapshotText: "You're currently assigned to the Apple Support Program. As a fresher with no prior Apple experience, your path starts at the very beginning — covering all foundational modules in sequence.",
    roleSkillsCurrent: [
      { skill_name: "Customer Communication", proficiency: "Beginner", assessment_year: 2026 },
      { skill_name: "Empathy and De-escalation", proficiency: "Beginner", assessment_year: 2026 },
      { skill_name: "Issue Probing and Clarification", proficiency: "Beginner", assessment_year: 2026 },
      { skill_name: "Case Documentation", proficiency: "Beginner", assessment_year: 2026 },
      { skill_name: "Knowledge Base Navigation", proficiency: "Beginner", assessment_year: 2026 },
      { skill_name: "Guided Troubleshooting", proficiency: "Beginner", assessment_year: 2026 },
      { skill_name: "Escalation Handling", proficiency: "Beginner", assessment_year: 2026 },
    ],
    roleSkillsRequired: [
      { skill_name: "Customer Communication", proficiency: "Advanced" },
    ...
    otherSkills: [
      { skill_name: "email communication", proficiency: "Intermediate", assessment_year: 2025 },
      { skill_name: "telephone etiquette", proficiency: "Beginner", assessment_year: 2025 },
      { skill_name: "oral communication", proficiency: "Intermediate", assessment_year: 2025 },
      { skill_name: "team collaboration", proficiency: "Beginner", assessment_year: 2025 },
      { skill_name: "time management", proficiency: "Beginner", assessment_year: 2025 },
      { skill_name: "Microsoft Office", proficiency: "Intermediate", assessment_year: 2025 },
    ],
  },
  u7: {
    title: "Regional Training Manager",
