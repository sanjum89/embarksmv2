...
export const st2BaselineAssessment: Assessment = {
  ...
  questions: [
    {
      id: "q-rb-bl-1",
      question: "What is the primary obligation of a discretionary investment manager when constructing a client portfolio?",
      options: [
        "Maximise short-term returns",
        "Ensure the portfolio is suitable for the client's objectives, risk profile, and circumstances",
        "Match a benchmark index as closely as possible",
        "Minimise all fees and charges",
      ],
      correctIndex: 1,
    },
    {
      id: "q-rb-bl-2",
      question: "Under FCA regulations, what must be documented before making an investment recommendation?",
      options: [
        "Only the final recommendation letter",
        "The client's objectives, risk appetite, capacity for loss, and rationale for the recommendation",
        "A disclaimer noting past performance",
        "The internal compliance sign-off only",
      ],
      correctIndex: 1,
    },
    {
      id: "q-rb-bl-3",
      question: "Which of the following best describes 'strategic asset allocation'?",
      options: [
        "Timing the market to buy low and sell high",
        "Setting a long-term mix of asset classes aligned with client objectives and risk tolerance",
        "Investing exclusively in equities for maximum growth",
        "Diversifying across fund managers to reduce operational risk",
      ],
      correctIndex: 1,
    },
    {
      id: "q-rb-bl-4",
      question: "When a client's risk appetite conflicts with their stated return objective, the investment manager should:",
      options: [
        "Prioritise the return objective to meet client expectations",
        "Educate the client on the trade-off and agree a realistic position together",
        "Default to the lowest-risk portfolio available",
        "Refer the case to compliance for resolution",
      ],
      correctIndex: 1,
    },
    {
      id: "q-rb-bl-5",
      question: "What role does the Financial Planning team play in the client relationship?",
      options: [
        "They manage all client communications",
        "They provide specialist advice on tax, pensions, and estate planning that informs the investment strategy",
        "They approve all trades before execution",
        "They handle client complaints and regulatory reporting",
      ],
      correctIndex: 1,
    },
  ],
