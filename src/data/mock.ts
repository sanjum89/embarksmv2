...
export const mockLearningModules: LearningModule[] = [
  ...
  ...expandedModules,
  { id: "m-rb1", title: "Rathbones Investment Manager Role and Good Client Outcomes", contentType: "document", contentUrl: "https://example.com/rathbones-im-role.pdf", duration: "20 min", transcript: "This document outlines the core responsibilities of an Investment Manager at Rathbones. You will learn about fiduciary duty, client-centricity, what constitutes a 'good client outcome' under Consumer Duty, and how Rathbones' values translate into day-to-day practice. Topics include understanding client segments, the importance of personalised service, and how your role fits within the broader wealth management team." },
  { id: "m-rb2", title: "Leading Client Relationships with Confidence", contentType: "video", contentUrl: "https://example.com/rathbones-client-relationships", duration: "25 min", transcript: "In this video, experienced Rathbones Investment Managers share how they build and maintain strong client relationships. Topics covered include first meeting preparation, setting expectations, establishing trust through transparency, managing difficult conversations, and the rhythm of ongoing client engagement — from annual reviews to ad-hoc check-ins." },
  { id: "m-rb3", title: "Suitability, Documentation, and Client Fairness", contentType: "document", contentUrl: "https://example.com/rathbones-suitability.pdf", duration: "20 min", transcript: "This guide covers suitability requirements under FCA regulations and Rathbones' internal standards. You will learn how to assess a client's risk appetite, capacity for loss, and investment objectives. The document also covers documentation best practices — what to record, how to structure suitability letters, and how to ensure fair treatment throughout the advice process." },
  { id: "m-rb4", title: "Working with Financial Planning, Portfolio Management, and Client Support", contentType: "video", contentUrl: "https://example.com/rathbones-internal-collab", duration: "25 min", transcript: "This video explores how Investment Managers collaborate with Financial Planners, Portfolio Managers, and Client Support teams at Rathbones. You will see examples of effective handoffs, joint client meetings, and how to present a unified approach to complex client needs including tax planning, pension drawdown, and estate planning." },
  { id: "m-rb5", title: "Investment Process and Portfolio Alignment Basics", contentType: "document", contentUrl: "https://example.com/rathbones-investment-process.pdf", duration: "20 min", transcript: "This document introduces Rathbones' investment process — from strategic asset allocation through to portfolio construction and rebalancing. You will learn how client mandates are translated into portfolio positions, the role of the Investment Committee, and how to ensure portfolios remain aligned with stated client objectives and risk parameters." },
  { id: "m-rb6", title: "Communicating Clearly with Clients and Internal Partners", contentType: "video", contentUrl: "https://example.com/rathbones-communication", duration: "25 min", transcript: "Effective communication is central to the Investment Manager role. This video covers how to explain complex investment concepts in plain language, write clear and professional client correspondence, deliver portfolio reviews with confidence, and communicate constructively with internal teams. Includes examples of good and poor communication across email, meetings, and reports." },
  { id: "m-rb7", title: "Professional Integrity, Attention to Detail, and Ownership", contentType: "document", contentUrl: "https://example.com/rathbones-integrity.pdf", duration: "15 min", transcript: "This final chapter covers the professional standards expected of Rathbones Investment Managers. Topics include taking personal ownership of client outcomes, maintaining meticulous attention to detail in documentation and portfolio management, upholding ethical standards, and demonstrating the integrity that underpins Rathbones' reputation in the wealth management industry." },
];
...
export const mockSkillTargets: SkillTarget[] = [
  ...
  },
  {
    ...
    steps: [
      { id: "s-rb-c1", type: "module", title: "Rathbones Investment Manager Role and Good Client Outcomes", description: "Core responsibilities, fiduciary duty, and what constitutes good client outcomes.", order: 1, skippable: true, status: "completed", duration: "20 min", referenceId: "m-rb1" },
      { id: "s-rb-c2", type: "module", title: "Leading Client Relationships with Confidence", description: "Building and maintaining strong client relationships at Rathbones.", order: 2, skippable: true, status: "completed", duration: "25 min", referenceId: "m-rb2" },
      ...
      { id: "s-rb-c4", type: "module", title: "Working with Financial Planning, Portfolio Management, and Client Support", description: "Internal collaboration across Financial Planning, Portfolio Management, and Client Support.", order: 4, skippable: false, status: "locked", duration: "25 min", referenceId: "m-rb4" },
