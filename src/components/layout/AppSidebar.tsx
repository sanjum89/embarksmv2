...
import { Loader2, LogOut, LogIn, Paintbrush, GitGraph, Code, Type, Archive, Settings as SettingsIcon } from "lucide-react";
...
const legacyMeItems: LegacyItem[] = [
...
const legacyTeamItems: LegacyItem[] = [
...
export function AppSidebar() {
  ...
  return (
    ...
    >
      {/* Brand + toggle */}
      <div className={cn("flex h-[60px] items-center border-b border-sidebar-border w-full", expanded ? "px-4" : "justify-center")}>
          ...
          <Popover>
            {expanded ? (
              <PopoverTrigger asChild>
                <button
                  className={cn(
                    "flex items-center rounded-lg transition-all duration-200 text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground h-9 gap-3 w-full px-3"
                  )}
                >
                  <Archive className="h-4 w-4 shrink-0" />
              ...
              <Tooltip delayDuration={0}>
                <TooltipTrigger asChild>
                  <PopoverTrigger asChild>
                    <button className="flex h-10 w-10 items-center justify-center rounded-lg text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground transition-colors">
                      <Archive className="h-4 w-4" />
                    </button>
                  </PopoverTrigger>
                </TooltipTrigger>
